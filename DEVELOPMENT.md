...
```bash
git remote add encore encore://wedding-invitation-system-n4k2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/wedding-invitation-system-n4k2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/wedding-invitation-system-n4k2/settings/integrations/github)
